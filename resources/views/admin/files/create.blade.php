                        ...
                        <form action="{{ route('admin.files.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="title" class="form-control" type="text" required
                                    value="{{ old('reference_no') }}" placeholder="Enter File Title">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="file_url" class="form-control" type="file" id="formFile" required>
                            </div>
                            <div>
                                <button class="btn btn-primary" type="submit"> Upload <i class="bx bx-save"></i> </button>
